            ...
            <>
                ...
                <div className="select-box">
                        ...
                        <div className="single">
...

                            {
                                ...
                                <div className="single__image">
                                    <img src={this.props.defaultValue ? this.props.defaultValue.image : ''} alt="single-image" />
                                </div>
                            }
...

                            {
                                ...
                                <div className="single__left">
                                    <span>
                                        {this.props.defaultValue ? this.props.defaultValue.left : ''}
                                    </span>
                                </div>
                            }
                        ...
                        <div className="indicator-box">
                            {
                                ...
                                this.props.disableSeparator === undefined && <div className="seperator"></div>
                    ...
                    <div ref={this.menuRef} className={`menu ${this.state.isOpen? 'is-open' : ''}`}>
                        ...
                        <div ref={this.menuListRef} className="menu-list">

                            {
                                this.state.options.length > 0 && 
                                this.state.options.map((p) => 
                                    <>
                                        <div ref={this.optionRef} onClick={(e) => this.handleSelected(e, p)} className="menu__option">
